...
describe("Tooltip.vue", () => {
  ...
  test("virtual triggering without virtualRef should not crash and not create popper", async () => {
    const wrapper = mount(Tooltip, {
      props: { virtualTriggering: true, manual: true },
    });
