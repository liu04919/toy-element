...
describe("Popconfirm.vue", () => {
  ...
  it("should render reference slot content correctly", () => {
    ...
    expect(wrapper.text()).toContain(referenceContent);
  });

  it("should render icon by default", async () => {
    const wrapper = mount(PopConfirm, {
      props: {
        ...props,
        icon: "check-circle",
    ...
    await triggerNode.trigger("click");
  ...
  it("should not render icon when icon prop is empty", async () => {
    const wrapper = mount(PopConfirm, {
      props: {
        ...props,
        icon: "",
    ...
    expect(wrapper.find(".er-popconfirm").exists()).toBeTruthy();
    expect(wrapper.find(".er-icon").exists()).toBeFalsy();
  });

  it("should not render icon when hideIcon prop is true", async () => {
    const wrapper = mount(PopConfirm, {
      props: {
        ...props,
        hideIcon: true,
